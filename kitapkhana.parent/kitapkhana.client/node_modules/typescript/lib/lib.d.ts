...
interface RTCIceCandidateBooks {
    foundation?: string;
    priority?: number;
    ip?: string;
    protocol?: string;
...
interface RTCIceCandidatePair {
    local?: RTCIceCandidateBooks;
    remote?: RTCIceCandidateBooks;
}
...
interface RTCIceGatherer extends RTCStatsProvider {
    ...
    getLocalCandidates(): RTCIceCandidateBooks[];
...
interface RTCIceGathererEvent extends Event {
    readonly candidate: RTCIceCandidateBooks | RTCIceCandidateComplete;
}
...
interface RTCIceTransport extends RTCStatsProvider {
    ...
    readonly state: string;
    addRemoteCandidate(remoteCandidate: RTCIceCandidateBooks | RTCIceCandidateComplete): void;
    createAssociatedTransport(): RTCIceTransport;
    getNominatedCandidatePair(): RTCIceCandidatePair | null;
    getRemoteCandidates(): RTCIceCandidateBooks[];
    getRemoteParameters(): RTCIceParameters | null;
    setRemoteCandidates(remoteCandidates: RTCIceCandidateBooks[]): void;
...
type RTCIceGatherCandidate = RTCIceCandidateBooks | RTCIceCandidateComplete;
